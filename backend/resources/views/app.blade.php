...
<head>
    ...
    <link href="/static/css/main.0993a2fd.chunk.css" rel="stylesheet">
</head>

<body>
    <noscript>You need to enable JavaScript to run this app.</noscript>
    <noscript>Você precisa ativar o JavaScript para rodar este app.</noscript>
    <div id="root"></div>
    <script>
        ! function (c) {
            function e(e) {
                for (var t, r, n = e[0], o = e[1], u = e[2], i = 0, a = []; i < n.length; i++) r = n[i], f[r] && a.push(
                    f[r][0]), f[r] = 0;
    ...
    <script src="/static/js/2.055784f8.chunk.js">

    </script>
    <script src="/static/js/main.961b72c3.chunk.js"></script>
</body>
</html>
